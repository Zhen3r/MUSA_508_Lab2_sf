...
ggplot()+
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = employment_rate),
          color = "transparent")+
  geom_sf(data = acsTractsPHL.2019.sf %>%
            filter(Neighborhood == "The university city") %>%
            st_union(),
          color = "white",
          fill = "transparent")+
  scale_fill_viridis(option="rocket")+
  labs(
    title = "Percentage of employment rate of Philadelphia by tract",
    subtitle = "University City, Philadelphia, 2019",
