...
``` r
acs_vars <- c( "B23025_001", # The population of 16 years olds and over
               "B23025_002") # Total number of the population in labor force

myTracts <- c("42101036900",
              "42101008801",
              "42101008802") # The university city
...
acsTractsPHL.2019.sf <- get_acs(geography = "tract",
  ...
  rename (total_population_over_16 = B23025_001E,
          total_employment_number = B23025_002E) %>%
  mutate(Neighborhood = ifelse(GEOID %in% myTracts,
                               "The university city",
                               "REST OF PHILADELPHIA"),
         employment_rate = total_employment_number / 
                           total_population_over_16) # to get the employment_rate
```
